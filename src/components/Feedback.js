...
class Feedback extends Component {
    ...
    render () {
        ...
        <Modal show={this.state.showModal} onHide={this.close}>
          ...
          <Form action={"mailto:kkkkk@oooo.com?subject="+subject+"&body="+fromusertext+this.state.inputUsernameValue+"%0D%0A"+messagetext+this.state.inputMessageValue} method="post" enctype="text/plain">
          <Modal.Body>
            <FormGroup>
                <InputGroup>
